...
#include <dinput.h>
#else
// Non-Windows builds use these DirectInput-compatible keyboard scan codes
// directly — SDL translates its own scancodes to these values (see
// Core/GameEngineDevice/Source/SDLDevice/GameClient/SDLKeyboard.cpp). Values
// are the standard PS/2 set-1 make codes that dinput.h's DIK_* expand to.
