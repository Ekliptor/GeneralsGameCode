...
{
	uint32_t					Version;
	uint32_t					Attributes;			// Uses same #defines as Mesh, e.g. W3D_MESH_FLAG_GEOMETRY_TYPE_SKIN
	...
	uint32_t					NumTris;				// number of triangles
	uint32_t					NumVertices;		// number of unique vertices
	uint32_t					NumSubMeshes;		// number of sub-meshes
	uint32_t					FutureCounts[5];	// future counts
...
struct W3dShdSubMeshHeaderStruct
{
	...
	uint32_t					NumTris;				// number of triangles
	uint32_t					NumVertices;		// number of unique vertices
	uint32_t					FutureCounts[2];	// future counts
