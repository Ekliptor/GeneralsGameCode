...
// Phase 5h — link-time stubs for the bgfx build. ShaderClass constructors are
// inline in shader.h so the static-member definitions here compile without the
// DX8 backend. Methods that touch D3D state machinery are provided as no-ops
// so unreachable callers link cleanly; bgfx has its own shader pipeline.
#include "w3d_file.h"

bool ShaderClass::ShaderDirty = true;
unsigned long ShaderClass::CurrentShader = 0;

// Phase D17 — bgfx-side preset values now match the DX8 path bit-for-bit.
// Earlier these were zero-initialised on the BGFX build because no path
// dispatched off them, but the particle pipeline (PointGroupClass::Render)
// reads the preset blend modes verbatim. With them defaulted to opaque
// (SRCBLEND_ONE / DSTBLEND_ZERO), additive / alpha sprites painted the
// black background of their textures over the scene. Same SHADE_CNST
// macros as the DX8 block above.
#define SC_OPAQUE        ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE,  COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ADDITIVE      ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE,                 FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_BUMPENVMAP    ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE,                 FOG_DISABLE, GRADIENT_BUMPENVMAP, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_ADD,     DETAILALPHA_DISABLE) )
#define SC_ALPHA         ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_MULTIPLICATIVE ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO,      DSTBLEND_SRC_COLOR,           FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_OP_2D         ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_OP_SPRITE     ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ADD_2D        ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE,                 FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ALPHA_2D      ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ADD_SPRITE    ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE,                 FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ALPHA_SPRITE  ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_OPAQUE_SOLID  ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE,  COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ADDITIVE_SOLID ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE,                 FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ALPHA_SOLID   ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ATEST_2D      ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_ENABLE,  CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ATEST_SPRITE  ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE,  COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ZERO,                FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_ENABLE,  CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ATESTBLEND_2D ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_ENABLE,  CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_ATESTBLEND_SPRITE ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_ENABLE,  CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_SCREEN_2D     ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE_MINUS_SRC_COLOR, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_SCREEN_SPRITE ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,       DSTBLEND_ONE_MINUS_SRC_COLOR, FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_MULTIPLICATIVE_2D ( SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO, DSTBLEND_SRC_COLOR,           FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
#define SC_MULTIPLICATIVE_SPRITE ( SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO, DSTBLEND_SRC_COLOR,        FOG_DISABLE, GRADIENT_DISABLE,  SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,  ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE) )
...
ShaderClass ShaderClass::_PresetScreen2DShader                (SC_SCREEN_2D);
ShaderClass ShaderClass::_PresetScreenSpriteShader            (SC_SCREEN_SPRITE);
ShaderClass ShaderClass::_PresetMultiplicative2DShader        (SC_MULTIPLICATIVE_2D);
ShaderClass ShaderClass::_PresetMultiplicativeSpriteShader    (SC_MULTIPLICATIVE_SPRITE);
