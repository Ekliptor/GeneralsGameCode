...
// part_ldr.cpp + part_emt.cpp now (gates lifted). The duplicate stubs
// here were returning nullptr from Load_W3D so .w3d-defined particle
// emitters never loaded.
// ============================================================================
...
// Load_Texture: BGFX implementation. The real one in Core/.../texture.cpp
...
// Skips the DX8-only bumpmap-format probing — bumpmaps are out of D8
// scope and would route through DX8Wrapper caps that don't yet model
// BGFX texture-format support cleanly.
